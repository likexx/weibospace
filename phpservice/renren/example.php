...
/*测试2：分页获取当前用户的好友信息列表
 */
$params = array('page'=>'1','count'=>'2','access_token'=>$accesstoken);//使用access_token调api的情况
...
'name'=>'baidu_sylogo1.png',
'tmp_name'=>'http://wiki.dev.renren.com/mediawiki/images/a/a7/Wiki2.png',//如果是服务器本地图片，可以这么写：'tmp_name'=>'c:/pic.jpg'
'type'=>'image/png'
));
$params = array('caption'=>'description','access_token'=>$accesstoken);//使用access_token调api的情况，两者的value格式是不同的，参见上面的变量
