  ...
  #Set the useragnet.
	...
	public function call_fopen($url,$method,$postFields=null,$username=null,$password=null,$contentType=null){
	 ...
	 public static function convertEncoding($source, $in, $out){
		...
		error_log('encoding not changed');
		return $source;
	}
	/**
...
//         return json_decode($response);
		 $convertedData = $this->convertEncoding($response,'utf-8',$this->_encode);
		 return json_decode($convertedData);
